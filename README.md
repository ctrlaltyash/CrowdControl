...
[Launch Demo](#-getting-started) · [Read the Paper](A_Nonlinear_Degenerate_Advection_Diffusion_Model_for_Crowd_Instability_and_Stampede_Risk_Prediction.pdf) · [View Results](#-simulation-results)
...
$$\mathbf{v} = \mathbf{v}_{\text{base}} \cdot \mu(\rho) \cdot \kappa_{\text{push}}$$
...
$$R(x,t) = \text{clamp}_{[0,1]}\!\left[\; \alpha \cdot \frac{\rho}{\rho_{\max}} \;+\; \delta \cdot \frac{1}{d + \varepsilon} \;+\; \gamma \cdot \frac{1}{|\mathbf{v}| + \varepsilon} \;+\; \eta \cdot \Psi(\rho) \;-\; c(x,t) \;\right]$$
...
| **Stagnation** — γ · 1/(|v| + ε) | 0.0* | Inverse speed (people unable to move = danger) |
...
|---|---|---|
| [TypeScript](https://www.typescriptlang.org/) | 5.5 | Type-safe language for both engine and frontend |
...
| [GSAP](https://gsap.com/) | Page transitions, magnetic hover, button ripples |
| [KaTeX](https://katex.org/) / [react-katex](https://github.com/talyssonoc/react-katex) | LaTeX math formula rendering |
...
| Tool | Purpose |
|---|---|
| [ESLint](https://eslint.org/) 10 | Code linting with React hooks & refresh plugins |
| [PostCSS](https://postcss.org/) + [Autoprefixer](https://github.com/postcss/autoprefixer) | CSS processing |
| [tsx](https://github.com/privatenumber/tsx) | TypeScript execution for CLI scripts |
| [@napi-rs/canvas](https://github.com/nicehash/napi-rs/canvas) | Server-side PNG rendering for batch results |
| [Node.js Test Runner](https://nodejs.org/api/test.html) | Built-in unit & invariant testing |
...
Open [http://localhost:5173](http://localhost:5173) in your browser. You'll see a landing page — click **"Launch Simulation"** to enter the interactive dashboard.
...
- **Research Paper**: [A Nonlinear Degenerate Advection-Diffusion Model for Crowd Instability and Stampede Risk Prediction](A_Nonlinear_Degenerate_Advection_Diffusion_Model_for_Crowd_Instability_and_Stampede_Risk_Prediction.pdf) — The mathematical foundation for this project.
