    ...
    <div className="app-root cyber-theme v4">
      <header className="app-header">
        <div className="header-brand">
          ...
          <div>
            <h1 className="brand-title">CROWD_SAFE AI</h1>
            <p className="brand-sub">PREDICTIVE MITIGATION & HAZARD ANALYSIS</p>
          </div>
        </div>
        ...
        <aside className="sidebar">
          ...
          <section className="sidebar-section">
            ...
            <div className="param-group">
                <label className="param-label">ENTRY_FLOW <span className="param-val neon-cyan">{entryRate.toFixed(1)} / sec</span></label>
          ...
          <section className="sidebar-section controls">
            <button onClick={handleStart} disabled={status === 'running'} className="launch-btn primary">EXECUTE</button>
            <div className="secondary-btns">
                <button onClick={handleStop} className="cyber-btn-alt">HALT</button>
