// The snitch panel. Tells you exactly where the simulation is failing.
...
export const AlertsPanel: React.FC<AlertsPanelProps> = ({ alerts }) => {
  ...
  // Slide it in from the right like a notification center
  useEffect(() => {
  ...
  // Animate new alerts as they pop into the list
  useEffect(() => {
    const ctx = gsap.context(() => {
  ...
  // Deciding which icon fits the vibe
  ...
  // Background tint for the alert cards
